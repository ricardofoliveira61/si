...
## Code fixes
If a subpackage is not identified and a no module named x error is raised, the solution is
...
Note: The solution is applied on the parent folder of the package
